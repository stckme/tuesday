...
def setup_routes(factory):
    ...
    factory.get('/stats/all')(statslib.get_all_stats)
    factory.get('/stats/comments/count/total')(statslib.total_comments)
    factory.get('/stats/comments/count/lastndays/{n}')(statslib.total_comments_lastNdays)
    factory.get('/stats/comments/count/monthly')(statslib.monthly_comments_count)
    factory.get('/stats/comments/count/monthly/lastnmonths/{n}')(statslib.monthly_comments_count_lastNmonths)
    factory.get('/stats/comments/count/weekly')(statslib.weekly_comments_count)
    factory.get('/stats/comments/count/weekly/lastnweeks/{n}')(statslib.weekly_comments_count_lastNweeks)
    factory.get('/stats/comments/count/hourly')(statslib.hourly_comments_count)
    factory.get('/stats/comments/count/hourly/lastndays/{n}')(statslib.hourly_comments_count_lastNdays)
    factory.get('/stats/commenters/count/weekly')(statslib.weekly_unique_commenters_count)
    factory.get('/stats/commenters/count/weekly/lastnweeks/{n}')(statslib.weekly_unique_commenters_count_lastNweeks)
    factory.get('/stats/commenters/count/monthly')(statslib.monthly_unique_commenters_count)
    factory.get('/stats/commenters/count/monthly/lastnmonths/{n}')(statslib.monthly_unique_commenters_count_lastNmonths)
    factory.get('/stats/commenters/count/yearly')(statslib.yearly_unique_commenters_count)
    factory.get('/stats/commenters/count/currentweek/top/{top}')(statslib.curr_week_top_commenters)
    factory.get('/stats/commenters/count/currentmonth/top/{top}')(statslib.curr_month_top_commenters)
    factory.get('/stats/commenters/count/currentyear/top/{top}')(statslib.curr_year_top_commenters)
    factory.get('/stats/commenters/count/monthly/top/{top}')(statslib.monthly_top_commenters)
    factory.get('/stats/commenters/count/monthly/top/{top}/lastnmonths/{n}')(statslib.monthly_top_commenters_lastNmonths)
    factory.get('/stats/assets/comments/count/monthly/top/{top}')(statslib.monthly_top_commented_articles)
    factory.get('/stats/assets/comments/count/monthly/top/{top}/lastnmonths/{n}')(statslib.monthly_top_commented_articles_lastNmonths)
    ...
    factory.get('/stats/commenters/editorspick')(statslib.featured_comments)
